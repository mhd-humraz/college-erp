...
// ✅ CLASS NAME MATCHES WHAT WE'RE CALLING ABOVE!
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color(0xFFA29BFE).withOpacity(0.15),
                    ...
                    SizedBox(height: 8),
                    Text(
                      'Submit a request to HOD to add a missing student to your class',
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: _isSubmitting 
                  ...
                  : Icon(Icons.send),
                label: Text(_isSubmitting ? 'Sending...' : 'Send Request to HOD'),
                style: ElevatedButton.styleFrom(backgroundColor: Color(0xFFA29BFE)),
              ),
            ),
          ],
        ),

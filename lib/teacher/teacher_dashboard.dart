        ...
        actions: [
          Padding(
            ...
            child: CircleAvatar(
              ...
              child: Text(
                (widget.user['name'] ?? 'T')[0].toUpperCase(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'This dashboard helps you manage attendance, assignments, timetable, leave letters, marks, study materials, and announcements easily.',
            style: TextStyle(
              fontFamily: 'Poppins',
              fontSize: 13,
              color: AppColors.text.withOpacity(0.5),
